        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                if (appointments.length > 0) {
                    return [2 /*return*/, res.status(200).json({ data: appointments })];
                }
                else {
                    return [2 /*return*/, res.status(500).json({ error: 'error while getting data' })];
                }
                return [2 /*return*/];
        }
    });
...
var addAppointment = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, patientName, contact, scheduled, serial, newData, savedData;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                savedData = _b.sent();
                if (savedData)
                    return [2 /*return*/, res.status(200).json({ success: 'data saved' })];
                else
